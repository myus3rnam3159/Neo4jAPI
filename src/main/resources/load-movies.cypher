...
//Studios that made the movies
CREATE (Columbia:Studio {name:'Columbia Pictures'})
CREATE (Universal:Studio {name:'Universal Pictures'})
CREATE (Paramount:Studio {name:'Paramount Pictures'})
CREATE (Fox:Studio {name:'20th Century Fox'})
CREATE (Warner:Studio {name:'Warner Bros.'})
CREATE (Lionsgate:Studio {name:'Lionsgate'})
